...
- `make package`: exit 0; provider assets were verified in the exact packaged bundle, and its embedded widget signature was valid on disk and satisfied its designated requirement. Log: `04-make-package.log`.
